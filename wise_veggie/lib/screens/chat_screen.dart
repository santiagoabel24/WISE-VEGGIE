...
class _NutriBotChatScreenState extends State<NutriBotChatScreen> {
  final String apiKey = "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";
  ...
  void initState() {
    ...
    messages.add({
      "role": "bot",
      "content": "¡Hola! 👋 Soy VeggieBot, tu asistente de salud y alimentación.\n\nPuedo ayudarte con consejos, recetas, calcular tu IMC o ingesta de agua.\n\nRecuerda que soy un asistente educativo y no reemplazo a tu médico. ¿En qué te ayudo today?"
    });
  }
          ...
          if (isTyping)
            Padding(
              ...
              child: Align(
                ...
                child: Text("VeggieBot está escribiendo...", style: TextStyle(color: Colors.grey, fontSize: 12)),
              ),
            ),
